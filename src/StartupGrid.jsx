...
const PortfolioCard = ({ title, category, year, bgColor, textColor, icon, className = "" }) => {
  return (
    <div className={`group cursor-pointer ${className}`}>
      <div className={`${bgColor} rounded-xl p-8 h-64 flex items-center justify-center mb-6 transition-all duration-300 group-hover:scale-105 group-hover:shadow-xl relative overflow-hidden border border-gray-100`}>
        ...
        <ArrowUpRight className={`absolute top-6 right-6 w-6 h-6 ${textColor} opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 translate-y-2 group-hover:translate-x-0 group-hover:translate-y-0`} />
      </div>
      <div className="flex justify-between items-center">
        <h3 className="text-gray-900 text-xl font-medium group-hover:text-blue-600 transition-colors duration-300">{title}</h3>
        <ArrowUpRight className="w-5 h-5 text-gray-400 group-hover:text-gray-900 group-hover:transform group-hover:translate-x-1 group-hover:-translate-y-1 transition-all duration-300" />
      </div>
      <p className="text-gray-500 text-sm mt-1">{category} / {year}</p>
    </div>
  );
};

// Agency Card Component
const AgencyCard = ({ className }) => (
  <PortfolioCard
    title="AGENCY"
    ...
    icon={<div className="w-8 h-8 border-3 border-white rounded-full border-dashed"></div>}
    className={className}
  />
);
...
const BusinessCard = ({ className }) => (
  <PortfolioCard
    ...
    icon={<div className="w-8 h-8 bg-blue-600 rounded transform rotate-45"></div>}
    className={className}
  />
);

// Startup Card Component
const StartupCard = ({ className }) => (
  <PortfolioCard
    title="STARTUP"
    category="Streaming"
    year="2020"
...
const ApplicationCard = ({ className }) => (
  <PortfolioCard
    title="APPLICATION"
    category="Streaming"
    year="2014"
    ...
    textColor="text-white"
    icon={<div className="w-8 h-5 bg-white rounded-full"></div>}
    className={className}
  />
);

// Main Demo Component showing all cards
const PortfolioDemo = () => {
  return (
    <div className="min-h-screen bg-white p-8 mt-8">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Portfolio Components</h1>
          <p className="text-gray-600">Individual reusable portfolio card components with hover animations</p>
        </div>
        ...
        <div className="space-y-16">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-6">Individual Components</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div>
                <h3 className="text-lg font-medium text-gray-700 mb-4">Agency Card</h3>
                <AgencyCard />
              </div>
              <div>
                <h3 className="text-lg font-medium text-gray-700 mb-4">Business Card</h3>
                <BusinessCard />
              </div>
              <div>
                <h3 className="text-lg font-medium text-gray-700 mb-4">Startup Card</h3>
                <StartupCard />
              </div>
            </div>
          </section>
          ...
          {/* Full Grid Example */}
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-6">Complete Portfolio Grid</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <AgencyCard />
              <BusinessCard />
              <StartupCard />
              <InstituteCard />
              {/* CompanyCard intentionally omitted here to avoid duplicate definition error */}
              <ApplicationCard />
            </div>
          </section>
        </div>
